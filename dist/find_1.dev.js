  ...
  return regeneratorRuntime.async(function main$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 5:
          _context.next = 7;
          return regeneratorRuntime.awrap(findOneListingByName(client, "Muskan Gupta"));
...
function findOneListingByName(client, nameOfListing) {
  var result;
  return regeneratorRuntime.async(function findOneListingByName$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return regeneratorRuntime.awrap(client.db("CAC").collection("student").findOne({
            name: nameOfListing
          }));
